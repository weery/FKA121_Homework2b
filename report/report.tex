...
\begin{equation}
E_{L}(\mathbf{r}_1,\mathbf{r}_2)= \frac{\mathbf{H}\psi_T(\mathbf{r}_1,\mathbf{r}_2)}{\psi_T(\mathbf{r}_1,\mathbf{r}_2)}
\end{equation}
and the normalised probability to be in this state is,
\begin{equation}
\rho(\mathbf{r}_1,\mathbf{r}_2)=\frac{|\psi_T(\mathbf{r}_1,\mathbf{r}_2)|^2}{\int dr_1dr_2|\psi_T(\mathbf{r}_1,\mathbf{r}_2)|^2}.
\end{equation}
...
\begin{equation}
\rho_{rel}(\mathbf{r'}_1,\mathbf{r'}_2,\mathbf{r}_1,\mathbf{r}_2)=\frac{|\psi_T(\mathbf{r'}_1,\mathbf{r}_2')|^2}{|\psi_T(\mathbf{r}_1,\mathbf{r}_2)|^2}.
\end{equation}
